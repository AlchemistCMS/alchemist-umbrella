...
config :gateway_web,
  ecto_repos: [Gateway.Repo],
  generators: [context_app: :gateway, binary_id: true]

# Configures the endpoint
config :gateway_web, GatewayWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "vrISuuT+wTsRcXOOpIZM/boIKiIXxaHzWYO5XnDAuribJosYPE5eDr6BmUNmzGCx",
  render_errors: [view: GatewayWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Gateway.PubSub,
  live_view: [signing_salt: "Ms6Q7Xvi"]
